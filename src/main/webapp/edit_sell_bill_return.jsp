				...
				<div class="col-lg-12">
					...
					<div class="card">
						...
						<div class="card-body" style="padding-top: 15px;">
							...
							<form action="SaleBillReturnServlet" method="post"
								...
								SaleBillDto bill_dto = sell_ser.getSaleBillReturnInfoById(id, config, request);
								%>
											...
											<tr>
													...
													<div class="col-md-12 refresh-container"
														...
														<div  class="refresh_button" title="Refresh Items">
															<i style="font-size: 12px;"
																class="fa fa-refresh main-color lock-refresh" 
																onclick="refreshItem();"></i> <a href="add_item.jsp"
																target="_blank" style="font-size: 12px;"
																class="plus-add-icon" title="Add Item"><i
												...
												<td>
													...
													<div class="form">
														...
														<input type="hidden" id="cat_id"> <input
															type="hidden" id="measure_id"> <input
															type="hidden" id="cat_name"> <input type="hidden"
												...
												<td>
													<div class="form">
														...
														<input type="number" class="form-control" id="dis_per"
															value="0" onblur="findDiscountAmtRow();" step=0.01 />
													</div>
												...
												<td>
													<div class="form">
														...
														<input type="number" class="form-control" id="dis_amt"
															value="0" onblur="findDiscountPerRow();" step=0.01 />
													</div>
												...
												<td>
													<div class="form">
														<input type="number" value="0" class="form-control"
															id="qty" onblur="findTotalRowAmount();" />
													</div>
												</td>
								...
								<div class="table-responsive mt-0" id="table_design">
									<table class="table">
										...
										<tbody id="tbody_design" class="text-center" class="tbody">
											<%
											SaleBillReturnService ser1 = new SaleBillReturnService();

											ArrayList<SaleBillItemDto> list_bill = ser1.getSaleBIllItemReturnInfoByBillId(id, config, request);
											int i = 1;
											...
											<tr>
												...
												<td align="center" style="display: none"><%=item_dto.getCat_name()%>
													...
													value="<%=item_dto.getHsn_code()%>"> <input
													id="gst_price_with_qty<%=i%>" type="hidden"
													name="Gst_price_with_qty"
													value="<%=item_dto.getItem_qty() * gst_price%>"></td>
												...
												<td align="center"><%=item_dto.getDiscount_per_amount()%><input
													...
													value="<%=item_dto.getDiscount_per_amount()%>" step=0.01></td>
												...
												<td align="center"><%=item_price_with_dis * item_dto.getItem_qty()%><input
													id="tot_amt<%=i%>" type="hidden" name="Tot_amt"
													value="<%=item_price_with_dis * item_dto.getItem_qty()%>"
													step=0.01></td>
								...
								<div class="col-md-2 col-6" id="paid_amount_block">
									<div class="control form-floating">
										<input readonly type="text" class="form-control"
											...
											placeholder="total_basic_amt" value="0" step=0.01> <label
											for="total_basic_amt">Total amount</label>
									</div>
								</div>
								...
								<div class="col-md-2 col-6" id="cash_block">
									<div class="control form-floating">
										<input type="text" class="form-control"
											...
											value="<%=bill_dto.getCash_amount()%>" step=0.01> <label
								...
								<div class="d-none" id="online_amt_block">
									<div class="control form-floating">
										<input type="text" class="form-control"
											...
											value="<%=bill_dto.getOnline_amount()%>" step=0.01> <label
									...
									<div class="col-md-3 col-6">
										<div class="control form-floating mb-3">
											<select class="form-select" id="online_way" name="Online_way"
												...
												<option value="N/A"
													<%if (bill_dto.getOnline_way().equalsIgnoreCase("N/A")) {
	out.print("selected");
}%>>Select
													payment way</option>
												<option value="gpay"
													<%if (bill_dto.getOnline_way().equalsIgnoreCase("gpay")) {
	out.print("selected");
}%>>Gpay</option>
												<option value="phonepay"
													<%if (bill_dto.getOnline_way().equalsIgnoreCase("phonepay")) {
	out.print("selected");
}%>>Phone
													Pay</option>
												<option value="paytm"
													<%if (bill_dto.getOnline_way().equalsIgnoreCase("paytm")) {
	out.print("selected");
}%>>Paytm</option>
												<option value="cheque"
													<%if (bill_dto.getOnline_way().equalsIgnoreCase("cheque")) {
	out.print("selected");
}%>>Cheque</option>
												<option value="online"
													<%if (bill_dto.getOnline_way().equalsIgnoreCase("online")) {
	out.print("selected");
}%>>Online</option>
									...
									<div class="col-md-3 refresh-container mb-3"
										...
										<div class="control form-floating refresh-input">
											<input type="text" class="form-control" id="bank_name"
												...
												value="<%=bill_dto.getBank_id_fk()%>" /> <label
						...
						<div  style="left: 0;margin-left: -1px;">
						<a  style="margin-right: 5px;color:red;" title="Refresh Bank" onclick="refreshBank();"><i class="fa fa-refresh  " id="lock-refresh"></i></a>
								<a href="add_bank.jsp" target="_blank" style="margin-right: 5px;" class="plus-add-icon" title="Add Bank"><i class="fas fa-edit"></i></a>
									...
									<!-- Bank Detail start -->
										...
										<div class="control form-floating mb-3 col-md-11 col-11">
											...
											<%
												BankService ser2 = new BankService();

												ArrayList<BankDto> list1 = ser2.getActiveBankInfo(config, request);

												for (BankDto Bank_dto : list1) {
												%>

												<option value="<%=Bank_dto.getId()%>"
												<%if(bill_dto.getBank_id_fk()==Bank_dto.getId()){out.print("selected");}%>>
													<%=Bank_dto.getName()%>
												</option>
