				...
				<div class="col-lg-10">
					...
					<div class="card" style="border-radius: 25px;">
						<div class="card-body">
							...
							VehicleInfoDto dto = service.getSoldVehicleInfoById(id, config, request);
							%>
							<br>
								...
								<div class="col-sm-4">
									<div class="control form-floating">
										...
										<input type="text" class="form-control" id="customer_name"
											name="Customer_name" value="<%=dto.getCustomer_name()%>"
											placeholder="Customer Name" required> <label
								...
								<div class="col-sm-4">
									<div class="control form-floating">
										...
										<input type="text" class="form-control" id="chassis_no"
											...
											placeholder="Chassis No." value="<%=dto.getChassis_no()%>"
											required> <label for="chassis_no">Chassis No.</label>
								...
								<div class="col-md-12">
									<div class="control form-floating">
										<textarea class="form-control" placeholder="Remark"
											id="remark" Name="Remark"  style="height: 70px">N/a</textarea>
		...
		function checkChassisNo() {
			...
			$.ajax({
						...
						success : function(msg) {
							...
							$('#rev').html(msg);
							var check_status = document
									.getElementById("check_status").value;
							var type = document.getElementById("type");
							//alert(check_status);
							if (check_status == "true") {
								var done_ser = Number(document
										.getElementById("done_ser").value);
								var ser_count = Number(document
										.getElementById("ser_count").value);
								var chasis_no_val = document
										.getElementById("chasis_no_val").value;
