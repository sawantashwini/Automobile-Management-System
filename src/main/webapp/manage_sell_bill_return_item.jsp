...
<body>
	...
	<!--  Breadcrumbs End-->
		...
		<div class="pagetitle text-center">
			<h1 id=page_title>Sell Return Item Report</h1>
		</div>
						...
						<table id="example" class="table hover" style="min-width: 100%;">
							...
							<thead id="thead">
								<tr>
									...
									<th style="width: 5%; text-align: center;">HSN code</th>
							...
							<tbody id="tbody" class="text-center">
								...
								ArrayList<SaleBillItemDto> list = service.getSellBillItemInfoReturn(d1, d2, search_item,all,  config, request);
								...
								<tr>
									...
									<td><%=dto.getItem_qty() + " " + dto.getMeasurement_name()%></td>
									<td class="main-color"><b><%=dto.getDiscount_sell_gst_price()%></b></td>

									<td><%=dto.getDiscount_per()%></td>
									<td><%=dto.getDiscount_per_amount()%></td>

									<td><%=dto.getGst_per()%></td>
									<td class="main-color"><b><%=dto.getHsn_code()%></b></td>
