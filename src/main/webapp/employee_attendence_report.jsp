...
<body onload="checkEmployeeNameIsCorrect('<%=name%>');">
						...
						<table id="example-small" class="table hover table-responsive"
							...
							<tbody class="text-center" id="tbody">
								...
								<tr>
									...
									<%
									if (user_sidebar_dto.getUpdate_module().equalsIgnoreCase("Yes")) {
									%>
									<td><a
									...
									%>
									<%
									if (user_sidebar_dto.getDelete_module().equalsIgnoreCase("Yes")) {
									%>
									<td><a
	...
	<script>
		...
		function printfunction() {
			return '<h1 style="text-align:center;margin-bottom:10px;">\n'+ employee_name + " " + page_title + "(" + month + "/"+ year + ")" + '</h1>';
		}
		function printTitle() {
			return employee_name + " " + page_title + "(" + month + "/" + year + ")";
		}
	</script>
