				...
				<div class="col-lg-12">
					...
					<div class="card" style="border-radius: 20px;">
						...
						<div class="card-body">
							...
							<form autocomplete="off" action="PurchaseBillReturnServlet"
								...
								<%
									PurchaseBillReturnService sell_ser = new PurchaseBillReturnService();
								...
								<div class="col-lg-2 col-md-2 col-6">
									<div class="control form-floating">
										...
										<input type="text" class="form-control" id="invoice_no"
											value="<%=max_invoice_id %>" name="Invoice_no"
											placeholder="invoice_no"> <label for="invoice_no">Invoice
											No.</label>
									</div>
								</div>
