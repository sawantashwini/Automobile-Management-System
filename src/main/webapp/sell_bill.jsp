					...
					<div class="card">
						...
						<div class="card-body" style="padding-top: 15px;">
							...
							<form autocomplete="off" action="SaleBillServlet" method="post"
									...
									<div class="row d-flex justify-content-center">
										...
										<div class="form-check col-3 mt-2">
											<input class="form-check-input" type="checkbox" id="regular"
												name="Regular" onclick="checkCustAvail();" value="Yes">
								...
								<div class="col-md-4">
									<div class="control form-floating">
										<input required type="text" class="form-control" id="name"
											name="Name" onblur="checkCustAvail();" placeholder="name"
								...
								<div class="col-md-4">
									<div class="control form-floating">
										<input type="number" class="form-control" id="mobile_no"
											name="Mobile_no" placeholder="mobile"> <label
												...
												<td>
													<div class="form">
														<input type="number" class="form-control" id="qty"
															value="1" onblur="findTotalRowAmount();"  step=0.01 />
													</div>
												</td>
												<td>
													<div class="form">
														<input type="date" class="form-control" id="warranty"
															onblur="findTotalRowAmount();" /> <input type="hidden"
															id="tot_amt" step=0.01 />
													</div>
												</td>
								...
								myButton.addEventListener("click", autoFocus);
								myButton.addEventListener("blur", autoFocus);</script>
									...
									<div class="col-md-3 col-6">
										<div class="control form-floating">
											<input type="date" class="form-control"
												placeholder="Online Date" id="online_date" value=""
								...
								<div class="text-center">
									<button type="submit"
										onclick="checkCustomerIsRegular();"
