									...
									<div class="col-md-3">
										<div class="control form-floating mb-3">
											<select class="form-select" id="online_way" name="Online_way"
												aria-label="working post">
												<option value="N/A" <%if (dto.getOnline_way().equalsIgnoreCase("N/A")) {out.print("selected");}%>>Select payment way</option>
												
												<option value="Gpay" <%if (dto.getOnline_way().equalsIgnoreCase("Gpay")) {out.print("selected");}%>>Gpay</option>
												
												<option value="Phonepay"<%if (dto.getOnline_way().equalsIgnoreCase("Phonepay")) {out.print("selected");}%>>PhonePay</option>
												
												<option value="Paytm"<%if (dto.getOnline_way().equalsIgnoreCase("Paytm")) {out.print("selected");}%>>Paytm</option>
												
												<option value="Cheque"<%if (dto.getOnline_way().equalsIgnoreCase("Cheque")) {out.print("selected");}%>>Cheque</option>
												
												<option value="Online"<%if (dto.getOnline_way().equalsIgnoreCase("Online")) {out.print("selected");}%>>Online</option>
