...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle text-center">
			<h1 id=page_title>Purchase Report</h1>
		</div>
...
<option
	...
	out.print("selected='selected'");
						...
						<table id="example" class="table hover" style="min-width: 100%;">
							...
							<tbody id="tbody" class="text-center">
								...
								ArrayList<PurchaseBillDto> list = service.getPurchaseBillInfo(d1, d2, all, config, request);
 ...
 %>
									...
									<td><a class="main-color"
										href="print_purchase_bill.jsp?id=<%=dto.getId()%>"><i
									...
									<td><a
										...
										href="AjaxService/AjaxDelete.jsp?purchase_id=<%=dto.getId()%>">
