...
<script src="js/purchasereturn.js" type="text/javascript"></script>
				...
				<div class="col-lg-12">
					...
					<div class="card" style="border-radius: 25px;">
						...
						<div class="card-body">
							...
							PurchaseBillDto dto1 = service.getPurchaseBillReturnInfoById(bill_id, config, request);
							%>


							<!-- Floating Labels Form -->
							<form name="frmMr" action="PurchaseBillReturnServlet"
								...
								<%-- <div class="col-md-4  d-flex justify-content-center">
									<div class="col-md-1 col-1">
										<div style="left: 0; margin-left: -4px;">
											<a style="margin-right: 5px; color: #f03c02;"
												title="Refresh Dealer " onclick="refreshDealer('Dealer');"><i
												class="fa fa-refresh  " id="lock-refresh"></i></a> <a
												href="add_dealer.jsp" target="_blank"
												style="margin-right: 5px;" class="plus-add-icon"
												title="Add Dealer"><i class="fas fa-edit"></i></a>
									...
									<div class="control form-floating mb-3 col-md-11 col-11">
										...
										<input readonly type="text" class="form-control"
											list="datalist_name" id="name" name="name" placeholder="Name"
										...
										<input type="hidden" id="dealer_id_fk" name="Dealer_id_fk"
											value="<%=dto1.getDealer_id_fk()%>" value="0">
										...
										<datalist id="datalist_name">
											...
											<%
											DealerService service2 = new DealerService();
											ArrayList<DealerDto> list3 = service2.getDealerInfo(config, request);
 ...
 --%>
												...
												<td>
													<div class="form">
														...
														<input type="text" class="form-control" id="dis_per"
															onblur="setItemDisPer();" value="0" step=0.01 />
													</div>
												</td>
												...
												<td>
													<div class="form">
														...
														<input type="text" class="form-control" id="tot_amt"
															value="0" /> <input type="hidden" id="gstamt_with_qty"
															value="0" step=0.01 />
												...
												<td class="text-center">
													<div class="control col-12">
														<input type="button" onfocus="insertMasterItem()"
								...
								<div class="table-responsive mt-0" id="table_design">
									<table class="table">
										...
										<tbody id="tbody_design" class="text-center" id="tbody">
											<%
											PurchaseBillReturnService serv = new PurchaseBillReturnService();

											ArrayList<PurchaseBillItemDto> list = serv.getPurchaseBillReturnItemInfoById(bill_id, config, request);
											...
											<tr>
												...
												<td><%=item_dto.getItem_code()%> <input type="hidden"
													...
													value="<%=item_dto.getItem_hsn_code()%>"> <input
													type="hidden" id="item_id<%=i%>" name="Item_id"
													value="<%=item_dto.getItem_id_fk()%>"> <input
													type="hidden" id="gstamt_with_qty<%=i%>"
													name="Gstamt_with_qty"
												...
												<td><%=item_dto.getGst_per()%> <input type="hidden"
													id="gst_per<%=i%>" name="Gst_per"
													value="<%=item_dto.getGst_per()%>"></td>

												<td><%=item_dto.getPur_base_price()%> <input
													type="hidden" id="pur_base_price<%=i%>"
													name="Pur_base_price"
													value="<%=item_dto.getPur_base_price()%>" step=0.01></td>

												<td><%=item_dto.getDiscount_per()%> <input
													type="hidden" id="dis_per<%=i%>" name="Dis_per"
													value="<%=item_dto.getDiscount_per()%>"></td>
												<td><%=item_dto.getDiscount_amt()%> <input
													type="hidden" id="dis_amt<%=i%>" name="Dis_amt"
												...
												<td><%=pur_discount_price * item_dto.getItem_qty()%> <input
													...
													value="<%=pur_discount_price * item_dto.getItem_qty()%>"
													step=0.01></td>



												<td><i class="bi bi-trash main-color"
													onclick="deletePurchaseItem('<%=item_dto.getId()%>');">
												</i></td>
											</tr>
