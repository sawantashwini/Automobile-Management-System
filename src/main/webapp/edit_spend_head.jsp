				...
				<div class="col-lg-8">
					...
					<div class="card" style="border-radius: 25px;">
						...
						%>
							...
							<!-- Floating Labels Form -->
							<form autocomplete="off" action="SpendHeadServlet" 
							...
							<div class="col-md-6">
									...
									<input type="hidden" name="User_id_fk" value="<%=user_id%>">
										...
										<input type="text" class="form-control" id="name"
											name="Name" value="<%=dto.getName()%>" placeholder="name" onblur="checkNameAvail(this.value, '0', 'Spend Head');" required> <label
											for="Name">Name</label>
