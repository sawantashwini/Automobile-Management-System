		...
		<div class="container">
				...
				<div style="background: #FFF; min-height: 420px; width: 720px;">
					<div
						...
						<div
							...
							<img src="ProjectImage/<%=project_dto.getId()%>.jpg" width="90px"
					...
					<div>
						...
						<table
							...
							<tr style="font-size: 13px;">
								...
								<td width="25%" style="text-align: center;">Total Salary</td>
							...
							<tr style="font-size: 13px; margin-left: 20px;">
								...
								<td style="text-align: center;"><%=dto.getPay_date()%>/<%=dto.getPaid_month()%>/<%=dto.getPaid_year()%></td>
								<td style="text-align: center;"><%=dto.getFinal_salary()%></td>
						...
						<table
							...
							<tr style="font-size: 13px;">
								<td width="100%" style="text-align: center;">Employee Working Days
									Details</td>
							</tr>
						</table>
						<table
							...
							<tr style="font-size: 13px;">
								...
								<td width="15%" style="text-align: center;">Present Days</td>
							...
							<tr style="font-size: 13px; margin-left: 20px;">
								...
								<td style="text-align: center;"><%=dto.getPresent_days()+dto.getAbsent_days()+(dto.getHalf_days()/2)+dto.getLeave_days()%></td>
							</tr>
						</table>
						...
						<table
							...
							<tr style="font-size: 13px; margin-left: 20px;">
								...
								<%
								if (dto.getOnline_date() == null || dto.getOnline_date().equalsIgnoreCase("")) {
								%>
								<td style="text-align: center;">N/A</td>
								<%
								} else {
								%>
								<td style="text-align: center;"><%=LogFileService.changeFormate(dto.getOnline_date(), "yyyy-MM-dd", "dd-MMMM-yyyy")%></td>
						...
						<table style="margin-left: 20px; width: 600px; font-weight: bold;">
							...
							<tr style="font-size: 13px;">
								<td width="70%" style="text-align: left; vertical-align: top;">Rs.<span
						...
						<div
							...
							<br /> <span style="font-size: 13px;">this is computer
								generated receipt , no signature required.</span>
						</div>
					</div>
				</div>
			</div>
			<table>
				<tr>
					...
					<td><a href="manage_employee.jsp"> <input type="button" value="Back"
							class="submit-btn" />
					</a></td>
				</tr>
			</table>
