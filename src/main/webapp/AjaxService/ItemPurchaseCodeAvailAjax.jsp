...
<input id="pur_base_price_val" type="hidden" value="<%=dto.getPur_price()%>" />
<input id="hsn_code_val" type="hidden" value="<%=dto.getHsn_code()%>" />
<input id="pur_item_status_val" type="hidden" value="<%=dto.getStatus()%>" />
<input id="sell_base_price_val" type="hidden"
	value="<%=dto.getSale_price()%>" />
