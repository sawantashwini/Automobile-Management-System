<%@page import="com.service.PurchaseBillReturnService"%>
...
if (dto.getId() == 0) {
	b = ser.insertOnePurchaseBillReturnItem(dto, request, config);
} else {
	b = ser.deleteOnePurchaseBillReturnItem(dto.getId(), request, config);
}
%>
