...
<%@page import="com.service.ServiceDueService"%>
...
<html>
<head>
<title>Service due receipt</title>
<style>
a {
...
<body>
	<div class="centered-container">
		...
		<%
			...
			ServiceDueService service = new ServiceDueService();
			ServiceBillDto dto = service.getServiceDueInfoByPaidId(id, config, request);
	...
	<table >
			...
			<th class="align-right " >Rec.no:</th>
				<td class=" align-left widths">R<%=id%></td>
		...
		<table >
			...
			<th class="align-right">Name:</th>
				<td class="align-left width" ><%=dto.getCustomer_name()%></td>
...
<table><tr class="total-row" style="height: 35px;">
				<th class="remark-width align-left" >Paid Amount:</th>
		...
		<table><tr class="total-row" >
				<th class="amt-width" style="border-top: none;">Amount in Words:</th>
