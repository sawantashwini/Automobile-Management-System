...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle text-center">
			<h1 id=page_title>Sell Report</h1>
		</div>
	...
	out.print("selected='selected'");
						...
						<table id="example" class="table hover nowrap"
							...
							<thead id="thead">
								<tr>
									...
									<th style="width: 6%; text-align: center;">Customer Mob
										No.</th>
									<th style="width: 10%; text-align: center;">Customer
										Address</th>
									<th style="width: 6%; text-align: center;">Final Amt.</th>
									<th style="width: 6%; text-align: center;">Paid Amt.</th>
									<th style="width: 4%; text-align: center;">Mode</th>
							...
							<tbody id="tbody" class="text-center">
								...
								ArrayList<SaleBillDto> list = service.getSaleBillInfo(d1, d2, all, config, request);
		...
		: LogFileService.changeFormate(dto.getOnline_date(), "yyyy-MM-dd", "dd-MM-yyyy")%></td>
									...
									<td><a
										...
										href="AjaxService/AjaxDelete.jsp?sell_id=<%=dto.getId()%>">
