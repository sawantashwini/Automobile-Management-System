...
<body>
	<div class="centered-container">
		...
		<%@include file="include/header_print.jsp"%>
		...
		<table>
			<tr>
				...
				<td class="align-left width1"><%=bill_dto.getCust_name()%></td>
			...
			<tr>
				...
				<td class="align-left width1"><%=bill_dto.getCust_mobile_no()%></td>
			...
			<tr>
				...
				<td class="align-left width1"><%=bill_dto.getCust_address()%></td>
				<th class="align-right">Gstin.:</th>
				<td class="input-width align-left"><%=bill_dto.getCust_gst_no()%></td>
			</tr>
		...
		<table>
			...
			<%
						ArrayList<SaleBillItemDto> list_bill = sell_ser.getSaleBIllItemInfoByBillId(id, config, request);
						int i = 1;
		...
		<div style="width: 51%; float: left;">
			<table>
				<tr class="total-row">
					<td colspan="6" class="border-right"><span class="center">Bank
							Info</span></td>
		...
		<div style="width: 49%; float: right;">
			...
			%>
				...
				<tr class="total-row">
					...
					<td colspan="3" style="color: #f00;"><span
						class="rupee-symbol"></span><%=format.format(bill_dto.getTotal_amt_with_gst())%></td>
				</tr>
				<%
								...
								%>
				<tr class="total-row">
					<td class="widthm"><span class="right height">Dis(<%=format.format(bill_dto.getDiscount_per())%>%)
							:
					</span></td>
				...
				<%} %>
				<tr class="total-row">
					<td class="widthm"><span class="right height ">Final
							Amt :</span></td>
					<td colspan="3"><span class="rupee-symbol"></span><%=Math.round(bill_dto.getFinal_amount())%></td>
				</tr>
				<tr class="total-row">
					<td class="widthm"><span class="right height ">Total
							Paid :</span></td>
		...
		<table>
			<tr class="total-row">
				<th class="align-left amt-width" style="border-top: none;">Amount
					in Words:</th>
		...
		<a class="home-button" id="home-button" href="manage_sell_bill.jsp">Home</a>
