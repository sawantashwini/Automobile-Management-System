...
public class DealerDueServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		dto.setOnline_remark(request.getParameter("Online_remark") == null ? "N/A" : request.getParameter("Online_remark"));
		...
		//************PAYMENT DTO VALUES***********
				...
				pay_dto.setOnline_remark(request.getParameter("Online_remark") == null ? "N/A" : request.getParameter("Online_remark"));
