...
public class SaleBillItemDto {
	int id,bill_id_fk,cat_id_fk,measurement_id_fk,item_id_fk;
	
	String cat_name,measurement_name,item_code,item_name,hsn_code,sell_item_status,current_in_date,warranty, customer_name,bill_date;
