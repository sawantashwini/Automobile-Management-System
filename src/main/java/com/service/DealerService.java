...
public class DealerService {
	...
	public DealerDto getDealerInfoByDueId(int id, ServletConfig config, HttpServletRequest request) throws IOException {
		...
		try {
			...
			String sql = "SELECT dt.id,user_id_fk, NAME, mobile_no, address, gst_no, old_due, opening_due, dt.status, \r\n"
					+ "pay_date, remark, payment_mode, online_way, online_remark, online_amount, cash_amount, online_date, bank_id_fk\r\n"
